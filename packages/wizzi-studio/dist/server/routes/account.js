/*
    ...
    primary source IttfDocument: C:\My\wizzi\wizzi-examples\packages\wizzi-studio\.wizzi\ittf\server\routes\account.js.ittf
*/
'use strict';
    ...
    app.get('/account/github/user', function(req, res, next) {
        ...
        axios.get('https://api.github.com/user', {
            ...
            axios.get(response.data.repos_url, {
                ...
                res.send("<p>You're logged in! Here's your data on GitHub: </p><pre><code>" + msg + '</code></pre><p>Go back to <a href="/">log in page</a>.</p>');
            })
        })
    });
};
