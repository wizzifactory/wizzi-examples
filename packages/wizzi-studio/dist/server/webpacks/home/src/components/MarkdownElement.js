/*
    ...
    primary source IttfDocument: C:\My\wizzi\wizzi-examples\packages\wizzi-studio\.wizzi\ittf\server\webpacks\home\src\components\MarkdownElement.js.ittf
*/
'use strict';
...
renderer.heading = (text, level) => {
    ...
    ;
    return (`<h${level}><a class="anchor-link" id="${escapedText}"></a>${text}` +`<a class="anchor-link-style" href="#${escapedText}">${'#'}</a></h${level}>`)};
marked.setOptions({
    gfm: true, 
    tables: true, 
    breaks: false, 
...
var styleSheet = createStyleSheet('MarkdownElement', (theme) => {
    return {
            root: {
