/*
    ...
    primary source IttfDocument: C:\My\wizzi\wizzi-examples\packages\wizzi-studio\.wizzi\ittf\server\config.js.ittf
*/
'use strict';
...
md.crawlBasePath = path.join(__dirname, 'data', 'crawl');
md.githubBasePath = path.join(__dirname, 'data', 'github');
